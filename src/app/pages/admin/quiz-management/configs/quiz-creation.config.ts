...
export const questionFormFieldForAddQuestionManually: DynamicFormField[] = [
  ...
  },
  {
    ...
    validationMessages: {
      ...
      pattern: 'Option 1 should not start with a space.',
    },
    gridClass: 'col-span-1 sm:col-span-1',
  },
  {
    ...
    validationMessages: {
      ...
      pattern: 'Option 2 should not start with a space.',
    },
    gridClass: 'col-span-1 sm:col-span-1',
  },
  {
    ...
    validationMessages: {
      ...
      pattern: 'Option 3 should not start with a space.',
    },
    gridClass: 'col-span-1 sm:col-span-1',
  },
  {
    ...
    validationMessages: {
      ...
      pattern: 'Option 4 should not start with a space.',
    },
    gridClass: 'col-span-1 sm:col-span-1',
  },
  {
    ...
    validationMessages: {
      ...
      pattern: 'Answer should not start with a space.',
    },
    gridClass: 'col-span-1 sm:col-span-2',
  },
];
