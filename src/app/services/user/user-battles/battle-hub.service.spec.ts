...
describe('BattleHubService', () => {
  ...
  afterEach(() => {
    // Complete all subjects and RxJS streams to avoid late emissions
    ...
    // Optionally, unsubscribe from any manual subscriptions
    // if you created them in your tests.
    // Reset Angular's TestBed to destroy the injector and avoid leaks
    TestBed.resetTestingModule();
    // Clear Jest mocks and timers
    jest.clearAllMocks();
    jest.clearAllTimers();
    jest.useRealTimers();
  });
  ...
  describe('incomingRequest$', () => {
    ...
    beforeEach(() => {
      // Reset the BehaviorSubject before each test
