...
describe('BattleManagementService', () => {
  ...
  it('should fetch battles with default batch number', (done) => {
    const mockApiResponse: ApiResponse<BattleManagementDataResponseDto> = {
      statusCode: 200,
      result: true,
      message: 'Success',
      data: {
    ...
    service.getBattles().subscribe((response: ApiResponse<BattleManagementDataResponseDto>) => {
  ...
  it('should fetch battles with custom batch number', (done) => {
    const batchNumber = 5;
    const mockApiResponse: ApiResponse<BattleManagementDataResponseDto> = {
      statusCode: 200,
      result: true,
    ...
    service
      .getBattles(batchNumber)
      .subscribe((response: ApiResponse<BattleManagementDataResponseDto>) => {
        expect(response.statusCode).toBe(200);
        done();
      });
